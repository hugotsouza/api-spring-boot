package com.hugotrindade.carrinho.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.hugotrindade.carrinho.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Spring Boot",
				"Esta API foi criada para fins didáticos", 
				"Versão 1.0",
				null ,
				new Contact("Hugo Trindade", "https://github.com/hugotsouza", "hugotrindade.dev@gmail.com"),
				"Uso público", 
				null , 
